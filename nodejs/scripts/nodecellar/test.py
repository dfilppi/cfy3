...
#j
#j    db.collection('wines', function(err, collection) {
#j        collection.insert(wines, {safe:true}, function(err, result) {});
#j    });



c=MongoClient("192.168.33.10",30000)
#print "got client"
w=c.winedb.wines

#print w.posts.insert(dbData())

print w.posts.find_one({"year":"2009"})
